...
export class LoginResponseDto {
    ...
    @ApiProperty({example: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlblR5cGUiOiJyZWZyZXNoVG9rZW4iLCJlbWFpbCI6IkV4YW1wbGVAZ21haWwuY29tIiwiaWQiOjM2LCJpYXQiOjE3MDI2MzE4MTIsImV4cCI6MTcwMzIzNjYxMn0.1wpfVHC4b8oZ2c_GQRPXp1ypGcN56-VPnGlOQL2m58E", description: "RefreshToken"})
